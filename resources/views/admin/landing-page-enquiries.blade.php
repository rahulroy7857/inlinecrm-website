...
@section('title', 'Landing Page Enquiries')
@push('custom-style')
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <form action="{{url('/admin/landing-page-enquiries')}}" method="post">
                  <div class="row">
                           {{ csrf_field() }}
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="EnquiriesTable" class="table table-bordered table-striped table-responsive">
                <thead>
                <tr>
                  <th>Sl.No</th>
                  <th>Name</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$enquiry->state}}</td>
                    <td>{{$enquiry->place}}</td>
                    <td>{{$enquiry->father}}</td>
                    <td>{{$enquiry->neet}}</td>
                    <td>{{$enquiry->dezired_coutry}}</td>
