      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="{{url('/admin/schools/'.$college->id)}}" enctype="multipart/form-data" autocomplete="off">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="state" required>
                        ...
                        <option value="{{$state->id}}" <?php if($college->state_id == $state->id) echo 'selected'; ?>>{{$state->name}}</option>
                        @endforeach
                      </select>
                     </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="textarea">Board</label>
                      <select class="form-control" name="board" required>
                        <option value="">Select</option>
                        <option value="CBSE" <?php if($college->board == 'CBSE') echo 'selected'; ?>>CBSE</option>
                        <option value="ICSE" <?php if($college->board == 'ICSE') echo 'selected'; ?>>ICSE</option>
                        <option value="IB" <?php if($college->board == 'IB') echo 'selected'; ?>>IB</option>
                        <option value="IGCSE" <?php if($college->board == 'IGCSE') echo 'selected'; ?>>IGCSE</option>
                        <option value="State Board" <?php if($college->board == 'State Board') echo 'selected'; ?>>State Board</option>
                      </select>
                     </div>
                  </div>
                  <div class="col-md-4">
