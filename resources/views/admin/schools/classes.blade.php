               ...
               @foreach($states as $state)
                <tr>
                  ...
                  <td class="text-center">
                    <button class="btn btn-primary btn-circle btn-sm Edit-Gallery" data-tooltip="tooltip" data-placement="top" title="Edit" href="" data-toggle="modal" data-target="#myModal" name="{{$state->name}}" edit-url="{{url('admin/classes/'.$state->id)}}"  ><i class="far fa-edit" aria-hidden="true"></i></button> 
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{url('admin/classes')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            {{csrf_field()}}
  ...
  <!-- Edit Gallery     -->
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Classe</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
