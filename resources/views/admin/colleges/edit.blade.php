      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="{{url('/admin/colleges/'.$college->id)}}" enctype="multipart/form-data" autocomplete="off">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <select class="form-control" name="type">
                            <option value="1" <?php if($college->type == 1) echo 'selected'; ?>>College</option>
                            <option value="2" <?php if($college->type == 2) echo 'selected'; ?>>PU College</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="textarea" name="slider_text" id="slider-text" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>{{$college->slider_text}}</textarea>
                     </div>
                  </div> -->
                  <div class="col-md-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="textarea" name="specializations" id="specializations" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!!$college->specializations!!}</textarea>
                     </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="textarea">Fees</label>
                      <textarea class="textarea" name="fees" id="fees" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!!$college->fees!!}</textarea>
                     </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="textarea">Placements</label>
                      <textarea class="textarea" name="placements" id="placements" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!!$college->placements!!}</textarea>
                     </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputFile">Recruitment</label>
                      <div class="input-group">
                        <div class="custom-file">
