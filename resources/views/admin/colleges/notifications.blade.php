              ...
              <table id="EnquiriesTable" class="table table-bordered table-striped">
               ...
               @foreach($exams as $program)
                <tr>
                  ...
                  <td>
                    <a data-tooltip="tooltip" data-placement="top" title="Delete!" onclick="return confirm('Want to Delete?')" href="{{url('admin/delete-college-notification/'.$program->id)}}" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>

                    <button class="btn btn-primary btn-circle btn-sm edit-course" data-tooltip="tooltip" data-placement="top" title="Edit" href="" data-toggle="modal" data-target="#myModal" exam="{{$program->name}}" name="{{$program->name}}" mtitle="{{$program->meta_title}}" mdes="{{$program->meta}}" details="{{$program->details}}" url="{{url('admin/update-college-notification/'.$program->id)}}"><i class="far fa-edit" aria-hidden="true"></i></button> 
                  </td>
                </tr>
               @endforeach
                </tbody>
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{url('admin/add-college-notification')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            {{csrf_field()}}
