              ...
              <table id="EnquiriesTable" class="table table-bordered table-striped">
               ...
               @foreach($programs as $program)
                <tr>
                  ...
                  <td>
                    <a data-tooltip="tooltip" data-placement="top" title="Delete!" onclick="return confirm('Want to Delete?')" href="{{url('admin/delete-abroad-colleges-program/'.$program->id)}}" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>

                    <button class="btn btn-primary btn-circle btn-sm edit-course" data-tooltip="tooltip" data-placement="top" title="Edit" href="" data-toggle="modal" data-target="#myModal" course="{{$program->course_id}}" name="{{$program->course_name}}" fee="{{$program->fee}}" mode="{{$program->mode}}" seat="{{$program->seat}}" exams="{{$program->exams}}" eligibility="{{$program->eligibility}}" duration="{{$program->duration}}" affiliation="{{$program->affiliation}}" popular="{{$program->status}}" url="{{url('admin/update-abroad-colleges-program/'.$program->id)}}"><i class="far fa-edit" aria-hidden="true"></i></button> 
                  </td>
                </tr>
               @endforeach
                </tbody>
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{url('admin/add-abroad-colleges-program')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            {{csrf_field()}}
            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Exams</label>
                      <input type="text" name="exams" class="form-control" required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
            ...
            <div class="modal-body">
              <div class="row">
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          <label for="exampleInputPassword1">Mode</label>
                          <select class="form-control edit-mode" name="mode" required>
                              <option value="">Select</option>
                              <option value="Full Time">Full Time</option>
                              <option value="Online">Online</option>
                          </select>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Exams</label>
                      <input type="text" name="exams" class="form-control edit-exam" required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
