               ...
               @foreach($blogs as $blog)
                <tr>
                  ...
                  <td class="text-center">
                    <a data-tooltip="tooltip" data-placement="top" title="Delete!" onclick="return confirm('Want to Delete?')" href="{{url('admin/delete-blog/'.$blog->id)}}" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    <button class="btn btn-primary btn-circle btn-sm Edit-Notification" data-tooltip="tooltip" data-placement="top" title="Edit" href="" data-toggle="modal" data-target="#myModal" ccontent="{{$blog->content}}" ctitle="{{$blog->title}}" mtitle="{{$blog->meta_title}}" ckey="{{$blog->meta_key}}" cdes="{{$blog->meta_desc}}" cauthor="{{$blog->author}}" cmeta="{{$blog->meta}}" ccategory="{{$blog->category}}" ccountry="{{$blog->country}}" edit-url="{{url('admin/blogs/'.$blog->id)}}"><i class="far fa-edit" aria-hidden="true"></i></button> 
                  </td>
                </tr>
                @endforeach
                </tbody>
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="{{url('admin/blogs')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            {{csrf_field()}}
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Autor</label>
                    <input type="text" name="author" class="form-control Edit-author" id="" placeholder="Author">
                  </div>
                </div>
              </div>
              <div class="row">
