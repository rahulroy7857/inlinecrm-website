...
@section('title', 'Mailer Enquiries')
@push('custom-style')
...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mailer Enquiries</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">Mailer Enquiries</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <form action="{{url('/admin/mailer-enquiries')}}" method="post">
                  <div class="row">
                           {{ csrf_field() }}
