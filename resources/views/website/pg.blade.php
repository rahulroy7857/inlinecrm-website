...
@endsection
@section('content')
<div class="inner-hero inner-hero-8" data-aos="fade-in" data-duration="0">
      <div class="container">
        <div class="inner-hero-wrap about-hero-wrap">
          <div class="inner-hero-left ">
            <h1 class="hero-title-txt">Explore <span class="highlighter">PG</span><br> Colleges
            </h1>
          ...
          <div class="inner-hero-right">
            <img src="{{url('/website/img/pg.webp')}}" alt="pg">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="scholar-sec-wrap">
          <div class="sholar-left" data-aos="fade-right" data-duration="200">
            <h3 class="sec-title"><span class="highlighter">PG Course</span></h3>
            <div class="comm-para">
              <p>For those who want to expand their knowledge, specialize in a particular sector, and improve their professional chances, postgraduate study is an essential first step. The correct postgraduate course can have a big impact on your career path and offer a solid basis for advancement and leadership roles, regardless of whether you want to take a professional course (MCA, LLM, etc.) or a Master's degree (M.A., M.Sc., M.Com, M.Tech, MBA, etc.).</p>
              <p>At KG2PG, we provide professional advice on how to choose the ideal Postgraduate (PG) degree for your academic interests, professional aspirations, and career goals.</p>
            </div>
          </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide" >
                <div class="courses-slides">
                  ...
                  <div class="f-row f-5">
                    @foreach($department->pgCourses as $course)
                    <div class="f-col">
