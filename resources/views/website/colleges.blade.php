...
<div class="inner-hero inner-hero-4" data-aos="fade-in" data-duration="0">
      <div class="container">
        <div class="inner-hero-wrap about-hero-wrap">
          <div class="inner-hero-left ">
            <h1 class="hero-title-txt">Discover <span class="highlighter">Colleges</span>
            </h1>
          ...
          <div class="inner-hero-right">
            <img src="{{url('/website/img/collegesgirl.png')}}" alt="Discover Colleges">
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Popular Colleges sec -->
    <div class="comm-section" data-aos="fade-in" data-duration="0">
      <div class="container">
        <h3 class="sec-title text-center"><span class="highlighter">Popular Colleges </span> in India!</h3>
        <br>
        <div class="comm-para sec-dtl">
          <p class="center">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        </div>
        <div class="courses-box-wrapper">
          <div class="f-row f-3 f-1024-2 f-768-1">
            @foreach($departments as $department)
            <div class="f-col">
              <a href="{{url('/top-ranked-'.$department->slug.'-colleges')}}" class="course-box">
                <div class="course-img"><img src="{{url('/storage/departments/'.$department->image)}}" alt="{{$department->name}}">
                </div>
                <div class="course-dtl">
                  <h3 class="course-name">{{$department->name}}</h3>
                </div>
              </a>
            </div>
            @endforeach
