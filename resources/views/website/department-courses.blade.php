      ...
      <div class="container">
        <div class="inner-hero-wrap about-hero-wrap">
          <div class="inner-hero-left ">
            <h1 class="hero-title-txt">Discover <span class="highlighter">{{$name}} </span>Courses
            </h1>
          ...
          <div class="inner-hero-right">
            <img src="{{url('/website/img/engineerboy.png')}}" alt="Discover Engineering Courses">
          </div>
        </div>
      </div>
    </div>
