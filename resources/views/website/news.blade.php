        ...
        <div class="container">
          ...
          <div class="blogs-hdr-sec">
            <div class="blog-hdr-left">
              <h1 class="page-hdr-title">All <strong>News</strong></h1>
            </div>
            <form method="get" action="{{url('/news')}}" id="form1">
            <div id="blogsearchForm" class="blog-search-form">
              ...
              <!-- <select name="titleSelect" id="titleSelect" class="select-field">
          ...
          <div class="blogs-sec-wrap">
            <div class="f-row f-3 f-1024-2 f-640-1">
              ...
              <div class="f-col">
                <div class="blogs-box">
                  <div class="blogs-img">
                    <img src="{{url('/storage/news/'.$news->resized_image)}}" alt="{{$news->title}}" />
                  </div>
                  <div class="blogs-dtl">
                    <h3 class="blogs-title">{{Str::limit($news->title, 50)}}</h3>
                    <a href="{{url('/news-details/'.$news->slug)}}" class="button line">Read More</a>
                  </div>
                </div>
              </div>
              @endforeach
