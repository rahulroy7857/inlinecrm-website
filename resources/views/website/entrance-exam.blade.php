...
@section('title', $exams->first()->meta_title ?? 'Entrance Exam')
@section('style-css')   
...
@endsection
@section('meta')
<meta name="description" content="{{ $exams->first()->meta }}" />
<meta property="og:title" content="{{ $exams->first()->meta_title }}" />
@endsection
@section('style')   
...
<div class="inner-hero inner-hero-9" data-aos="fade-in" data-duration="0">
    ...
    <div class="container">
      <ul class="breadcrumb">
        ...
        <li><a href="{{url('/entrances/'.$slug)}}">{{$name}}</a></li>
