...
class CreateAbroadCollegeCoursesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('abroad_college_courses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('abroad_college_courses');
    }
}
